/**
 * RapidAPI Tier Middleware — FallScout API
 *
...
const TIERS = {
  ...
  BASIC: {
    name: 'Free',
    price: 0,
    limits: { perMonth: 10, perDay: 3, perMinute: 2 },
  },
  PRO: {
    name: 'Pro',
    price: 29,
    limits: { perMonth: 100, perDay: 10, perMinute: 5 },
  },
  ULTRA: {
    name: 'Business',
    price: 99,
    limits: { perMonth: 1000, perDay: 100, perMinute: 20 },
  },
  MEGA: {
    name: 'Enterprise',
    price: -1,
